...
TEST(QS16_VMUL_MINMAX_FP32__SCALAR_U1, batch_eq_1) {
  VBinaryMicrokernelTester()
    .batch_size(1)
    .Test(xnn_qs16_vmul_minmax_fp32_ukernel__scalar_u1, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
}
...
TEST(QS16_VMUL_MINMAX_FP32__SCALAR_U2, batch_eq_2) {
  VBinaryMicrokernelTester()
    .batch_size(2)
    .Test(xnn_qs16_vmul_minmax_fp32_ukernel__scalar_u2, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
}
...
TEST(QS16_VMUL_MINMAX_FP32__SCALAR_U4, batch_eq_4) {
  VBinaryMicrokernelTester()
    .batch_size(4)
    .Test(xnn_qs16_vmul_minmax_fp32_ukernel__scalar_u4, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
}
...
TEST(QS16_VMUL_MINMAX_FP32__SCALAR_U8, batch_eq_8) {
  VBinaryMicrokernelTester()
    .batch_size(8)
    .Test(xnn_qs16_vmul_minmax_fp32_ukernel__scalar_u8, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
}
...
TEST(QS16_VMUL_MINMAX_FP32__SCALAR_U8, qmax) {
  ...
  TEST(QS16_VMUL_MINMAX_FP32__SSE41_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__sse41_u8, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__SSE41_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__sse41_u16, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__AVX2_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__avx2_u16, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__AVX2_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__avx2_u32, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__AVX512BW_U32, batch_eq_32) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(32)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__avx512bw_u32, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__AVX512BW_U64, batch_eq_64) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(64)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__avx512bw_u64, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__WASMSIMD_U8, batch_eq_8) {
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__wasmsimd_u8, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__WASMSIMD_U16, batch_eq_16) {
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__wasmsimd_u16, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__NEON_U8, batch_eq_8) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(8)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__neon_u8, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
  ...
  TEST(QS16_VMUL_MINMAX_FP32__NEON_U16, batch_eq_16) {
    ...
    VBinaryMicrokernelTester()
      .batch_size(16)
      .Test(xnn_qs16_vmul_minmax_fp32_ukernel__neon_u16, VBinaryMicrokernelTester::OpType::Mul, xnn_init_qs16_minmax_params, xnn_qs16_requantize_fp32);
  }
