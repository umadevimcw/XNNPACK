...
class VBinaryMicrokernelTester {
 public:
  ...
  void Test(xnn_qs16_vmin_ukernel_fn vbinary, OpType op_type,
            xnn_init_qs16_min_minmax_params_fn init_params = nullptr, xnn_qs16_requantize_fn requantize = nullptr) const;
