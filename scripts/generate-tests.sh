...
tools/generate-vbinary-test.py --tester VBinaryMicrokernelTester  --spec test/qs16-vmin.yaml   --output test/qs16-vmin.cc &
tools/generate-vbinary-test.py --tester VBinaryCMicrokernelTester --spec test/qs16-vminc.yaml    --output test/qs16-vminc.cc &
