...
//   Template: src/s16-vlshift/s16-vrlshiftc.c.in
...
void xnn_s16_vrlshiftc_ukernel__scalar_u1(
    size_t batch,
...
void xnn_s16_vrlshiftc_ukernel__scalar_u2(
    size_t batch,
    const int16_t* input1,
    const int16_t* input2,
    int16_t* output,
    const union xnn_s16_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 2 * sizeof(int16_t); batch -= 2 * sizeof(int16_t)) {
    ...
    xnn_simd_s16_t vy_0 = xnn_sllv_s16(vin2, vin1_0);
    xnn_simd_s16_t vy_1 = xnn_sllv_s16(vin2, vin1_1);
...
void xnn_s16_vrlshiftc_ukernel__scalar_u4(
    size_t batch,
    const int16_t* input1,
    const int16_t* input2,
    int16_t* output,
    const union xnn_s16_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(int16_t); batch -= 4 * sizeof(int16_t)) {
    ...
    xnn_simd_s16_t vy_0 = xnn_sllv_s16(vin2, vin1_0);
    xnn_simd_s16_t vy_1 = xnn_sllv_s16(vin2, vin1_1);
    xnn_simd_s16_t vy_2 = xnn_sllv_s16(vin2, vin1_2);
    xnn_simd_s16_t vy_3 = xnn_sllv_s16(vin2, vin1_3);
...
void xnn_s16_vrlshiftc_ukernel__scalar_u8(
    size_t batch,
    const int16_t* input1,
    const int16_t* input2,
    int16_t* output,
    const union xnn_s16_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int16_t); batch -= 8 * sizeof(int16_t)) {
    ...
    xnn_simd_s16_t vy_2 = xnn_sllv_s16(vin2, vin1_2);
    xnn_simd_s16_t vy_3 = xnn_sllv_s16(vin2, vin1_3);
    xnn_simd_s16_t vy_4 = xnn_sllv_s16(vin2, vin1_4);
    xnn_simd_s16_t vy_5 = xnn_sllv_s16(vin2, vin1_5);
    xnn_simd_s16_t vy_6 = xnn_sllv_s16(vin2, vin1_6);
    xnn_simd_s16_t vy_7 = xnn_sllv_s16(vin2, vin1_7);
