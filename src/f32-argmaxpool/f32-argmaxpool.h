...
#define XNN_UKERNEL_WITH_PARAMS(arch_flags, ukernel, primary_tile, incremental_tile, channel_tile, vector_tile, datatype, params_type, init_params) \
    XNN_UKERNEL(arch_flags, ukernel, primary_tile, incremental_tile, channel_tile, vector_tile, datatype)
#define XNN_DEFINED_UKERNEL_WITH_PARAMS
#endif

#ifndef XNN_UKERNEL
#define XNN_UKERNEL(arch_flags, ukernel, primary_tile, incremental_tile, channel_tile, vector_tile, datatype) \
...
//XNN_UKERNEL_WITH_PARAMS(0, xnn_f32_argmaxpool_ukernel_9p8x__scalar_c1, 9, 8, 1, false, float, struct xnn_f32_default_params, nullptr)
...
//XNN_UKERNEL_WITH_PARAMS(xnn_arch_x86_sse2, xnn_f32_argmaxpool_ukernel_9p8x__sse2_c4, 9, 8, 4,false, float, struct xnn_f32_default_params, nullptr)
