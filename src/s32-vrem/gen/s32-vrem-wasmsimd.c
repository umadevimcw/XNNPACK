...
//   Template: src/s32-vrem/s32-vrem.c.in
...
void xnn_s32_vrem_ukernel__wasmsimd_u4(
    size_t batch,
...
void xnn_s32_vrem_ukernel__wasmsimd_u8(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
...
void xnn_s32_vrem_ukernel__wasmsimd_u12(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 12 * sizeof(int32_t); batch -= 12 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_rem_s32(vin1_0, vin2_0);
    xnn_simd_s32_t vy_1 = xnn_rem_s32(vin1_1, vin2_1);
    xnn_simd_s32_t vy_2 = xnn_rem_s32(vin1_2, vin2_2);
...
void xnn_s32_vrem_ukernel__wasmsimd_u16(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 16 * sizeof(int32_t); batch -= 16 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_1 = xnn_rem_s32(vin1_1, vin2_1);
    xnn_simd_s32_t vy_2 = xnn_rem_s32(vin1_2, vin2_2);
    xnn_simd_s32_t vy_3 = xnn_rem_s32(vin1_3, vin2_3);
