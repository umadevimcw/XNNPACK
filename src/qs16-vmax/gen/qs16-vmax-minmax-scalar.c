...
//   Template: src/qs16-vmax/qs16-vmax.c.in
...
void xnn_qs16_vmax_minmax_fp32_ukernel__scalar_u1(
    size_t batch,
    ...
    const union xnn_qs16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= xnn_simd_bytes_s16; batch -= xnn_simd_bytes_s16) {
    ...
    xnn_simd_s32_t vy_s32_low = xnn_max_s32(vin1_low, vin2_low);
    xnn_simd_s32_t vy_s32_high = xnn_max_s32(vin1_high, vin2_high);
...
void xnn_qs16_vmax_minmax_fp32_ukernel__scalar_u2(
    size_t batch,
    const int16_t* input_a,
    const int16_t* input_b,
    int16_t* output,
    const union xnn_qs16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 2 * sizeof(int16_t); batch -= 2 * sizeof(int16_t)) {
    ...
    xnn_simd_s32_t vy_s32_low_0 = xnn_max_s32(vin1_low_0, vin2_low_0);
    xnn_simd_s32_t vy_s32_high_0 = xnn_max_s32(vin1_high_0, vin2_high_0);
    ...
    xnn_simd_s32_t vy_s32_low_1 = xnn_max_s32(vin1_low_1, vin2_low_1);
    xnn_simd_s32_t vy_s32_high_1 = xnn_max_s32(vin1_high_1, vin2_high_1);
...
void xnn_qs16_vmax_minmax_fp32_ukernel__scalar_u4(
    size_t batch,
    const int16_t* input_a,
    const int16_t* input_b,
    int16_t* output,
    const union xnn_qs16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(int16_t); batch -= 4 * sizeof(int16_t)) {
    ...
    xnn_simd_s32_t vy_s32_low_2 = xnn_max_s32(vin1_low_2, vin2_low_2);
    xnn_simd_s32_t vy_s32_high_2 = xnn_max_s32(vin1_high_2, vin2_high_2);
    ...
    xnn_simd_s32_t vy_s32_low_3 = xnn_max_s32(vin1_low_3, vin2_low_3);
    xnn_simd_s32_t vy_s32_high_3 = xnn_max_s32(vin1_high_3, vin2_high_3);
...
void xnn_qs16_vmax_minmax_fp32_ukernel__scalar_u8(
    size_t batch,
    const int16_t* input_a,
    const int16_t* input_b,
    int16_t* output,
    const union xnn_qs16_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int16_t); batch -= 8 * sizeof(int16_t)) {
    ...
    xnn_simd_s32_t vy_s32_low_4 = xnn_max_s32(vin1_low_4, vin2_low_4);
    xnn_simd_s32_t vy_s32_high_4 = xnn_max_s32(vin1_high_4, vin2_high_4);
    ...
    xnn_simd_s32_t vy_s32_low_5 = xnn_max_s32(vin1_low_5, vin2_low_5);
    xnn_simd_s32_t vy_s32_high_5 = xnn_max_s32(vin1_high_5, vin2_high_5);
    ...
    xnn_simd_s32_t vy_s32_low_6 = xnn_max_s32(vin1_low_6, vin2_low_6);
    xnn_simd_s32_t vy_s32_high_6 = xnn_max_s32(vin1_high_6, vin2_high_6);
    ...
    xnn_simd_s32_t vy_s32_low_7 = xnn_max_s32(vin1_low_7, vin2_low_7);
    xnn_simd_s32_t vy_s32_high_7 = xnn_max_s32(vin1_high_7, vin2_high_7);
