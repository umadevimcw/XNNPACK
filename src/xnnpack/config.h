...
XNN_INTERNAL const struct xnn_binary_elementwise_config* xnn_init_s16_vlshift_config();
XNN_INTERNAL const struct xnn_binary_elementwise_config* xnn_init_s32_vlshift_config();
