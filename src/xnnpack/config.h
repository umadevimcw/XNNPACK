...
XNN_INTERNAL const struct xnn_binary_elementwise_config* xnn_init_qs16_vmax_config();
XNN_INTERNAL const struct xnn_binary_elementwise_config* xnn_init_qs16_vmul_config();
