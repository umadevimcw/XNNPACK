...
typedef void (*xnn_qs16_vbinary_ukernel_fn)(
    size_t batch, const int16_t* input_x, const int16_t* input_y,
    int16_t* output,
    const union xnn_qs16_min_minmax_params
        params[XNN_RESTRICT XNN_MIN_ELEMENTS(1)]);
*/
...
// VMIN: Vector MIN elementwise with Min+Max activation

typedef void (*xnn_qs16_vmin_ukernel_fn)(
    size_t batch, const int16_t* input_x, const int16_t* input_y,
    int16_t* output,
    const union xnn_qs16_min_minmax_params
        params[XNN_RESTRICT XNN_MIN_ELEMENTS(1)]);
...
typedef size_t (*xnn_init_qs16_min_minmax_params_fn)(
    union xnn_qs16_min_minmax_params params[XNN_MIN_ELEMENTS(1)],
    int16_t a_zero_point, int16_t b_zero_point, float scale,
    int16_t output_zero_point,int16_t output_min,int16_t output_max);
