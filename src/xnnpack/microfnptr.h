...
// VCLZ: Vector Cound leading Zeros for 32 bit integer
...
// VCLZ: Vector Cound leading Zeros for 16 bit integer

typedef void (*xnn_s16_vclz_ukernel_fn)(
    size_t batch, const int16_t* input, int16_t* output,
