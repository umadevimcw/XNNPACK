...
void xnn_s32_vrem_ukernel__avx512f_u32(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int32_t); batch -= 32 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_rem_s32(vin1_0, vin2_0);
    xnn_simd_s32_t vy_1 = xnn_rem_s32(vin1_1, vin2_1);
  ...
  if XNN_UNLIKELY(batch != 0) {
    xnn_simd_s32_t vin1 = xnn_load_tail_s32(input_a, batch >> XNN_LOG2_SIZEOF_FLOAT);

    xnn_simd_s32_t vin2 = xnn_load_tail_s32(input_b, batch >> XNN_LOG2_SIZEOF_FLOAT);

    xnn_simd_s32_t vy = xnn_rem_s32(vin1, vin2);

    xnn_store_tail_s32(output, vy, batch >> XNN_LOG2_SIZEOF_FLOAT);
  }
}

void xnn_s32_vremc_ukernel__avx512f_u32(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 32 * sizeof(int32_t); batch -= 32 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_rem_s32(vin1_0, vin2);
    xnn_simd_s32_t vy_1 = xnn_rem_s32(vin1_1, vin2);
...
void xnn_s32_vrremc_ukernel__avx512f_u32(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  if XNN_UNLIKELY(batch != 0) {
    xnn_simd_s32_t vin2 = xnn_load_tail_s32(input_a, batch >> XNN_LOG2_SIZEOF_FLOAT);
