...
void xnn_s16_vlshift_ukernel__avx2_u16(
    size_t batch,
...
void xnn_s16_vlshiftc_ukernel__avx2_u16(
    size_t batch,
...
void xnn_s16_vrlshiftc_ukernel__avx2_u16(
    size_t batch,
    const int16_t* input1,
    const int16_t* input2,
    int16_t* output,
...
void xnn_s32_vlshift_ukernel__avx2_u16(
    size_t batch,
...
void xnn_s32_vlshiftc_ukernel__avx2_u16(
    size_t batch,
...
void xnn_s32_vrlshiftc_ukernel__avx2_u16(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
