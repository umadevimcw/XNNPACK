...
static struct xnn_binary_elementwise_config qs16_vmax_config = {0};
...
static struct xnn_binary_elementwise_config qu8_vmul_config = {0};
  ...
  static INIT_ONCE init_guard_qs16_vmax = INIT_ONCE_STATIC_INIT;
  ...
  static pthread_once_t init_guard_qs16_vmax = PTHREAD_ONCE_INIT;
...
static void init_qs16_vmax_config(void) {
#if XNN_ARCH_ARM
  const struct xnn_hardware_config* hardware_config =
      xnn_init_hardware_config();
  assert(hardware_config != NULL);
  if (hardware_config->use_arm_neon) {
    qs16_vmax_config.minmax.op_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmax_minmax_fp32_ukernel__neon_u8;
    qs16_vmax_config.minmax.opc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__neon_u8;
    qs16_vmax_config.minmax.ropc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__neon_u8;
    qs16_vmax_config.init.qs16_minmax = xnn_init_qs16_minmax_params;
    qs16_vmax_config.minmax.element_tile = 8;
  } else if (!XNN_PLATFORM_MOBILE) {
    qs16_vmax_config.minmax.op_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmax_minmax_fp32_ukernel__scalar_u2;
    qs16_vmax_config.minmax.opc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__scalar_u2;
    qs16_vmax_config.minmax.ropc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__scalar_u2;
    qs16_vmax_config.init.qs16_minmax = xnn_init_qs16_minmax_params;
    qs16_vmax_config.minmax.element_tile = 2;
  }
#elif XNN_ARCH_ARM64
  qs16_vmax_config.minmax.op_ukernel =
      (xnn_vbinary_ukernel_fn)xnn_qs16_vmax_minmax_fp32_ukernel__neon_u8;
  ...
  if (!XNN_PLATFORM_MOBILE && hardware_config->use_x86_avx512f) {
    qs16_vmax_config.minmax.op_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmax_minmax_fp32_ukernel__avx512bw_u32;
    qs16_vmax_config.minmax.opc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__avx512bw_u32;
    qs16_vmax_config.minmax.ropc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__avx512bw_u32;
    qs16_vmax_config.init.qs16_minmax = xnn_init_qs16_minmax_params;
    qs16_vmax_config.minmax.element_tile = 32;
  }
  if (hardware_config->use_x86_avx2) {
    qs16_vmax_config.minmax.op_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmax_minmax_fp32_ukernel__avx2_u16;
    qs16_vmax_config.minmax.opc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__avx2_u16;
    qs16_vmax_config.minmax.ropc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__avx2_u16;
    qs16_vmax_config.init.qs16_minmax = xnn_init_qs16_minmax_params;
    qs16_vmax_config.minmax.element_tile = 16;
  } else {
    qs16_vmax_config.minmax.op_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmax_minmax_fp32_ukernel__sse41_u8;
    qs16_vmax_config.minmax.opc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__sse41_u8;
    qs16_vmax_config.minmax.ropc_ukernel =
        (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__sse41_u8;
    qs16_vmax_config.init.qs16_minmax = xnn_init_qs16_minmax_params;
    qs16_vmax_config.minmax.element_tile = 8;
...
#elif XNN_ARCH_WASMSIMD || XNN_ARCH_WASMRELAXEDSIMD
  qs16_vmax_config.minmax.op_ukernel =
      (xnn_vbinary_ukernel_fn)xnn_qs16_vmax_minmax_fp32_ukernel__wasmsimd_u16;
  qs16_vmax_config.minmax.opc_ukernel =
      (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__wasmsimd_u16;
  qs16_vmax_config.minmax.ropc_ukernel =
      (xnn_vbinary_ukernel_fn)xnn_qs16_vmaxc_minmax_fp32_ukernel__wasmsimd_u16;
  qs16_vmax_config.init.qs16_minmax = xnn_init_qs16_minmax_params;
  qs16_vmax_config.minmax.element_tile = 16;
...
static void init_qu8_vmul_config(void) {
  ...
  static BOOL CALLBACK init_qs16_vmax_config_windows(PINIT_ONCE init_once,
                                                     PVOID parameter,
                                                     PVOID* context) {
    init_qs16_vmax_config();
    return TRUE;
  }
...
const struct xnn_binary_elementwise_config* xnn_init_qs16_vmax_config() {
  const struct xnn_hardware_config* hardware_config = xnn_init_hardware_config();
  if (hardware_config == NULL) {
    return NULL;
  }
  #if XNN_PLATFORM_WINDOWS
  InitOnceExecuteOnce(&init_guard_qs16_vmax, &init_qs16_vmax_config_windows,
                      NULL, NULL);
#else
  pthread_once(&init_guard_qs16_vmax, &init_qs16_vmax_config);
#endif
  return &qs16_vmax_config;
}
