...
//   Template: src/s32-vlshift/s32-vlshift.c.in
...
void xnn_s32_vlshift_ukernel__scalar_u1(
    size_t batch,
    ...
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= xnn_simd_bytes_s32; batch -= xnn_simd_bytes_s32) {
    ...
    xnn_simd_s32_t vy = xnn_sllv_s32(vin1, vin2);
...
void xnn_s32_vlshift_ukernel__scalar_u2(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 2 * sizeof(int32_t); batch -= 2 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_sllv_s32(vin1_0, vin2_0);
    xnn_simd_s32_t vy_1 = xnn_sllv_s32(vin1_1, vin2_1);
...
void xnn_s32_vlshift_ukernel__scalar_u4(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(int32_t); batch -= 4 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_0 = xnn_sllv_s32(vin1_0, vin2_0);
    xnn_simd_s32_t vy_1 = xnn_sllv_s32(vin1_1, vin2_1);
    xnn_simd_s32_t vy_2 = xnn_sllv_s32(vin1_2, vin2_2);
    xnn_simd_s32_t vy_3 = xnn_sllv_s32(vin1_3, vin2_3);
...
void xnn_s32_vlshift_ukernel__scalar_u8(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
    const union xnn_s32_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int32_t); batch -= 8 * sizeof(int32_t)) {
    ...
    xnn_simd_s32_t vy_2 = xnn_sllv_s32(vin1_2, vin2_2);
    xnn_simd_s32_t vy_3 = xnn_sllv_s32(vin1_3, vin2_3);
    xnn_simd_s32_t vy_4 = xnn_sllv_s32(vin1_4, vin2_4);
    xnn_simd_s32_t vy_5 = xnn_sllv_s32(vin1_5, vin2_5);
    xnn_simd_s32_t vy_6 = xnn_sllv_s32(vin1_6, vin2_6);
    xnn_simd_s32_t vy_7 = xnn_sllv_s32(vin1_7, vin2_7);
