...
void xnn_s32_vlshift_ukernel__neon_u4(
    size_t batch,
...
void xnn_s32_vlshift_ukernel__neon_u8(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
...
void xnn_s32_vlshift_ukernel__neon_u12(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
...
void xnn_s32_vlshift_ukernel__neon_u16(
    size_t batch,
    const int32_t* input_a,
    const int32_t* input_b,
    int32_t* output,
