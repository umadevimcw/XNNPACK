...
void xnn_s32_vlshiftc_ukernel__wasmsimd_u4(
    size_t batch,
...
void xnn_s32_vlshiftc_ukernel__wasmsimd_u8(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
...
void xnn_s32_vlshiftc_ukernel__wasmsimd_u12(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
...
void xnn_s32_vlshiftc_ukernel__wasmsimd_u16(
    size_t batch,
    const int32_t* input1,
    const int32_t* input2,
    int32_t* output,
