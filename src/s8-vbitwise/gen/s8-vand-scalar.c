...
void xnn_s8_vand_ukernel__scalar_u1(
    size_t batch,
...
void xnn_s8_vand_ukernel__scalar_u2(
    size_t batch,
    const int8_t* input_a,
    const int8_t* input_b,
    int8_t* output,
...
void xnn_s8_vand_ukernel__scalar_u4(
    size_t batch,
    const int8_t* input_a,
    const int8_t* input_b,
    int8_t* output,
    const union xnn_s8_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 4 * sizeof(int8_t); batch -= 4 * sizeof(int8_t)) {
    ...
    xnn_simd_s8_t vy_0 = xnn_and_s8(vin1_0, vin2_0);
    xnn_simd_s8_t vy_1 = xnn_and_s8(vin1_1, vin2_1);
    xnn_simd_s8_t vy_2 = xnn_and_s8(vin1_2, vin2_2);
    xnn_simd_s8_t vy_3 = xnn_and_s8(vin1_3, vin2_3);
...
void xnn_s8_vand_ukernel__scalar_u8(
    size_t batch,
    const int8_t* input_a,
    const int8_t* input_b,
    int8_t* output,
    const union xnn_s8_default_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  for (; batch >= 8 * sizeof(int8_t); batch -= 8 * sizeof(int8_t)) {
    ...
    xnn_simd_s8_t vy_2 = xnn_and_s8(vin1_2, vin2_2);
    xnn_simd_s8_t vy_3 = xnn_and_s8(vin1_3, vin2_3);
    xnn_simd_s8_t vy_4 = xnn_and_s8(vin1_4, vin2_4);
    xnn_simd_s8_t vy_5 = xnn_and_s8(vin1_5, vin2_5);
    xnn_simd_s8_t vy_6 = xnn_and_s8(vin1_6, vin2_6);
    xnn_simd_s8_t vy_7 = xnn_and_s8(vin1_7, vin2_7);
