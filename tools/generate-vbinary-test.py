...
def split_ukernel_name(name):
  match = re.fullmatch(r"xnn_(qu8|qs8|f16|f32|s32)_v(add|cmul|copysign|div|lshift|max|min|mul|sqrdiff|sub|addc|copysignc|rcopysignc|divc|rdivc|lshiftc|rlshiftc|maxc|minc|mulc|sqrdiffc|subc|rsubc)(_(minmax|relu)(_(fp32|rndnu))?)?_ukernel__(.+)_u(\d+)(v)?", name)
  if match is None:
