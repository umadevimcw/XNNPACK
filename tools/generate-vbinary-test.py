...
def split_ukernel_name(name):
  match = re.fullmatch(r"xnn_(qu8|qs8|f16|f32|s32|s8)_v(add|and|andc|cmul|copysign|div|max|min|mul|or|orc|sqrdiff|sub|addc|copysignc|rcopysignc|divc|rdivc|maxc|minc|mulc|sqrdiffc|subc|rsubc|xor|xorc)(_(minmax|relu)(_(fp32|rndnu))?)?_ukernel__(.+)_u(\d+)(v)?", name)
  if match is None:
